  ...
  const projects: Project[] = [
    {
      ...
      thumbnails: [
        "https://img.youtube.com/vi/ROnhAKqhhnw/1.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/maxresdefault.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/3.jpg"
      ],
      mainImage: "https://img.youtube.com/vi/ROnhAKqhhnw/maxresdefault.jpg",
      year: "2023",
    ...
    },
    {
      ...
      thumbnails: [
        "https://img.youtube.com/vi/ROnhAKqhhnw/mqdefault.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/1.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/2.jpg"
      ],
      mainImage: "https://img.youtube.com/vi/ROnhAKqhhnw/maxresdefault.jpg",
      year: "2022-2024",
    ...
    },
    {
      ...
      award: "스토리보드 총괄",
      desc: "영상 제작 및 연출",
      longDesc: "국내 유수의 아트 페스티벌을 위해 브랜드 아이덴티티를 담은 스토리보드를 구성하고 영상을 제작했습니다. 시각적인 임팩트와 메시지 전달력을 극대화하여 관객들의 몰입도를 높이는 데 기여했습니다.",
      thumbnails: [
        "https://img.youtube.com/vi/ROnhAKqhhnw/2.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/3.jpg",
        "https://img.youtube.com/vi/ROnhAKqhhnw/1.jpg"
      ],
      mainImage: "https://img.youtube.com/vi/ROnhAKqhhnw/hqdefault.jpg",
      year: "2023",
        ...
        {projects.map((project, idx) => (
          ...
          >
            <div className="relative overflow-hidden rounded-[2.5rem] mb-6 shadow-md transition-shadow hover:shadow-xl bg-[#4A3E31]">
              {/* Thumbnail Collage Grid */}
              <div className="grid grid-cols-3 w-full aspect-[21/9] overflow-hidden opacity-90 group-hover:opacity-100 transition-opacity">
                {project.thumbnails.map((thumb, tIdx) => (
                  <div key={tIdx} className="relative overflow-hidden border-r border-[#FCF9F2]/10 last:border-0">
                    <img 
                      src={thumb} 
                      alt={`${project.title} thumb ${tIdx}`} 
            ...
            <div className="flex justify-between items-start px-4">
              ...
              <span className="text-xs font-bold text-[#A67B5B] uppercase tracking-widest pt-2">
                {project.tag}
              </span>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative bg-[#FCF9F2] w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-[2.5rem] shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col">
            ...
            <div className="px-8 sm:px-12 pb-12">
              <div className="mb-10 rounded-3xl overflow-hidden shadow-lg aspect-video relative group">
                <img 
                ...
                <div className="grid grid-cols-3 gap-4 pt-4">
                  {selectedProject.thumbnails.map((thumb, idx) => (
                    <img 
                      key={idx} 
                      src={thumb} 
                      className="rounded-xl border border-[#D7C9B1]/20 shadow-sm" 
